...
// No `tailwindcss-animate` plugin here (see src/index.css; Tailwind v4
// zero-config), so the dialog appears/disappears instantly instead of using
// shadcn/ui's default transition classes.
  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Content
        ...
        className={cn(
          "fixed top-1/2 left-1/2 z-50 grid w-full max-w-sm -translate-x-1/2 -translate-y-1/2 gap-4 " +
