...
describe("copyText", () => {
  ...
  // Without this, a browser that does have `navigator.clipboard` would still fall through to
  ...
  // Without this, the Portal served over plain http (not a secure context, so
